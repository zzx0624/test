...
class Net(torch.nn.Module):
    def __init__(self, v_feat, a_feat, edge_index, batch_size, num_user, num_item, aggr_mode,
    ...
    def loss(self, user_tensor, item_tensor):
        ...
        out = self.forward()
        u_g_embeddings, i_g_embeddings = torch.split(out, [self.num_user, self.num_item], dim=0)
        user_score = u_g_embeddings[user_tensor]
        item_score = i_g_embeddings[item_tensor]
